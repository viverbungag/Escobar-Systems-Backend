...
CREATE TABLE IF NOT EXISTS employee_income_per_month(
    ...
    payPerHour DECIMAL(30, 2),
    total_hours_worked DECIMAL (30, 2),
    overtimePayPerHour DECIMAL (30,2),
    total_overtime_hours_worked DECIMAL (30,2),
    gross_pay DECIMAL (30,2),
...
CREATE TABLE IF NOT EXISTS supply(
    ...
    supply_quantity DECIMAL(30, 2) NOT NULL,
    supplier_id BIGINT,
    unit_of_measurement_id BIGINT,
    supply_category_id BIGINT,
    minimum_quantity DECIMAL(30, 2),
    is_active BOOLEAN DEFAULT true,
...
CREATE TABLE IF NOT EXISTS transaction(
    ...
    supplier_id BIGINT,
    transaction_supply_quantity DECIMAL(30, 5),
    supply_id BIGINT,
    price_per_unit DECIMAL(30, 5),
...
CREATE TABLE IF NOT EXISTS menu(
    ...
    menu_price DECIMAL(30, 2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS menu_ingredients(
    ...
    menu_id BIGINT,
    supply_id BIGINT,
    quantity DECIMAL(30, 2) NOT NULL DEFAULT 0,
